<template>
  <v-card class="hoverable" elevation="2">
    <v-img :src="card.poster_path" gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)" height="200px" cover>
    ...
    <v-card-actions class="justify-end">
      <v-btn icon>
        <v-icon color="yellow">{{ card.favorite ? 'mdi-heart' : 'mdi-heart-outline' }}</v-icon>
      </v-btn>
